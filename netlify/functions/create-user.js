...
exports.handler = async (event) => {
  ...
  // Only an existing coordinator may create new logins.
  ...
  if (!roleResponse.ok || !roleRows.length || roleRows[0].role !== 'coordinator') {
    return { statusCode: 403, body: JSON.stringify({ error: 'Only a coordinator can add team members.' }) };
  }
